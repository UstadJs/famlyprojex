...
exports.run = function (client, message, args) {
  ...
  message.channel.send(":mega: Başarıyla duyuruldu!");
    kanal.createWebhook("' Nᴀʀᴋᴏᴛɪᴋ Duyuru", "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQYMTbkB9kOpUs75-FNXeqPMMMXmXhdD22Rb4VXRtVKyrUWgnHz")
    .then(webhook => webhook.edit("' Nᴀʀᴋᴏᴛɪᴋ Duyuru", "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQYMTbkB9kOpUs75-FNXeqPMMMXmXhdD22Rb4VXRtVKyrUWgnHz")
        .then(wb => {
